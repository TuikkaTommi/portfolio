...
if (!$_POST['name'] || !$_POST['species'] || !$_POST['owner_name'] || !$_POST['owner_phone']) {
  echo 'Virhe lemmikin lisäämisessä. Palaa listaan tästä: <a href="../views/list.php">Palaa takaisin</a>';
} else {
  ...
  // Kutsutaan addPet()-funktiota uuden lemmikin tiedoilla
  addPet($name, $species, $dateofbirth, $allergies, $medication, $owner_name, $owner_phone, $connection);
